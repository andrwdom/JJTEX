...
export function getCorsHeaders(req, origin) {
    ...
    const headers = {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, token, x-requested-with, Accept, Origin, If-None-Match, If-Modified-Since, Cache-Control, Pragma, Expires',
